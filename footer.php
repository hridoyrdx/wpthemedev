    ...
    <div id="bottom-footer">
      ...
      <div class="footer-bottom-cms">
        <div class="footer-payment">
          <ul>
            <li class="mastero"><a href="#"><img alt="" src="<?php echo get_template_directory_uri(); ?>/image/payment/mastero.jpg"></a></li>
            <li class="visa"><a href="#"><img alt="" src="<?php echo get_template_directory_uri(); ?>/image/payment/visa.jpg"></a></li>
            <li class="currus"><a href="#"><img alt="" src="<?php echo get_template_directory_uri(); ?>/image/payment/currus.jpg"></a></li>
            <li class="discover"><a href="#"><img alt="" src="<?php echo get_template_directory_uri(); ?>/image/payment/discover.jpg"></a></li>
          </ul>
        </div>
      </div>
    </div>
