              ...
              <ul class="list-unstyled blog-wrapper" id="latest-blog">
                ...
                <li class="item blog-slider-item">
                  <div class="blog1 blog">
                    <div class="blog-image"> <a href="#" class="blog-imagelink"><?php the_post_thumbnail(); ?></a> <span class="blog-hover"></span> <span class="blog-readmore-outer"></span> </div>
                    <div class="blog-content">
                      <h2 class="blog-name"><a href="<?php the_permalink(); ?>" ><?php the_title(); ?></a></h2>
                      <span class="blog-author">Poted by: <a href="#"><?php the_author(); ?></a></span><span class="blog-date"><?php the_date(); ?></span> <a href="<?php the_permalink(); ?>" class="blog-readmore">Read more</a> </div>
                  </div>
                </li>
